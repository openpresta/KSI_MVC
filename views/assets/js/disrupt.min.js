if (! function(t, e) {
        ...
        ot.fn.extend({
            ...
            attr: function(t, e, n) {
                var i, o, s = t.nodeType;
                return t && 3 !== s && 8 !== s && 2 !== s ? typeof t.getAttribute === kt ? ot.prop(t, e, n) : (1 === s && ot.isXMLDoc(t) || (e = e.toLowerCase(), i = ot.attrHooks[e] || (ot.expr.match.bool.test(e) ? Te : xe)), void 0 === n ? i && "get" in i && null !== (o = i.get(t, e)) ? o : (o = ot.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void ot.removeAttr(t, e)) : void 0
            },
...
function() {
    ...
    t.fn.visible = function(t, n, i) {
        if (!(this.length < 1)) {
            var o = this.length > 1 ? this.eq(0) : this,
                ...
                a = e.height(),
                i = i ? i : "both",
                l = n === !0 ? s.offsetWidth * s.offsetHeight : !0;
    ...
    return function t(e, n, i) {
        ...
        1: [function(t, e, n) {
            ...
            function s(t) {
                t = t || {}, this._startOffsetX = 0, this._currentOffsetX = 0, this._opening = !1, this._moved = !1, this._opened = !1, this._preventOpen = !1, this._touch = void 0 === t.touch ? !0 : t.touch && !0, this.panel = t.panel, this.menu = t.menu, -1 === this.panel.className.search("slideout-panel") && (this.panel.className += " slideout-panel"), -1 === this.menu.className.search("slideout-menu") && (this.menu.className += " slideout-menu"), this._fx = t.fx || "ease", this._duration = parseInt(t.duration, 10) || 300, this._tolerance = parseInt(t.tolerance, 10) || 70, this._padding = this._translateTo = parseInt(t.padding, 10) || 256, this._orientation = "right" === t.side ? -1 : 1, this._translateTo *= this._orientation, this._touch && this._initTouchEvents()
            }
            var r, a = t("decouple"),
                l = t("emitter"),
                c = !1,
                ...
                this._onScrollFn = a(d, "scroll", function() {
                    ...
                    if (!c && !t._preventOpen && "undefined" != typeof e.touches) {
                        ...
                        if (!(Math.abs(i) > t._padding) && Math.abs(n) > 20) {
                            ...
                            if (t._opened && o > 0 || !t._opened && 0 > o) return;
                            0 >= o && (i = n + t._padding * t._orientation, t._opening = !1), t._moved || -1 !== u.className.search("slideout-open") || (u.className += " slideout-open"), t.panel.style[h + "transform"] = t.panel.style.transform = "translate3d(" + i + "px, 0, 0)", t.emit("translate", i), t._moved = !0
                        }
                    }
        ...
        3: [function(t, e, n) {
            ...
            var o = function() {
                ...
                return t.prototype.on = function(t, e) {
                    ...
                    for (var e = this, i = arguments.length, o = Array(i > 1 ? i - 1 : 0), s = 1; i > s; s++) o[s - 1] = arguments[s];
                    var n = void 0;
            ...
            addItem: function(e, n) {
                ...
                N(this, i, function() {
                    var i, o, s, r, a, l = this,
                        c = l.settings.mode;
                    return e = S(e), -1 !== l.items.indexOf(e) ? void("single" === c && l.close()) : void(l.options.hasOwnProperty(e) && ("single" === c && l.clear(n), "multi" === c && l.isFull() || (i = t(l.render("item", l.options[e])), a = l.isFull(), l.items.splice(l.caretPos, 0, e), l.insertAtCaret(i), (!l.isPending || !a && l.isFull()) && l.refreshState(), l.isSetup && (s = l.$dropdown_content.find("[data-selectable]"), l.isPending || (o = l.getOption(e), r = l.getAdjacentOption(o, 1).attr("data-value"), l.refreshOptions(l.isFocused && "single" !== c), r && l.setActiveOption(l.getOption(r))), !s.length || l.isFull() ? l.close() : l.positionDropdown(), l.updatePlaceholder(), l.trigger("item_add", e, i), l.updateOriginalInput({
                        silent: n
                    })))))
                })
            },
    ...
    function(t) {
        ...
        e = function() {
            ...
            return i = o.options.centerMode === !0 ? o.slideWidth * Math.floor(o.options.slidesToShow / 2) : 0, o.options.swipeToSlide === !0 ? (o.$slideTrack.find(".slick-slide").each(function(e, s) {
                return s.offsetLeft - i + t(s).outerWidth() / 2 > -1 * o.swipeLeft ? (n = s, !1) : void 0
            ...
            return e = e || !1, l.animating === !0 && l.options.waitForAnimate === !0 || l.options.fade === !0 && l.currentSlide === t || l.slideCount <= l.options.slidesToShow ? void 0 : (e === !1 && l.asNavFor(t), i = t, a = l.getLeft(i), r = l.getLeft(l.currentSlide), l.currentLeft = null === l.swipeLeft ? r : l.swipeLeft, l.options.infinite === !1 && l.options.centerMode === !1 && (0 > t || t > l.getDotCount() * l.options.slidesToScroll) ? void(l.options.fade === !1 && (i = l.currentSlide, n !== !0 ? l.animateSlide(r, function() {
                l.postSlide(i)
            }) : l.postSlide(i))) : l.options.infinite === !1 && l.options.centerMode === !0 && (0 > t || t > l.slideCount - l.options.slidesToScroll) ? void(l.options.fade === !1 && (i = l.currentSlide, n !== !0 ? l.animateSlide(r, function() {
                l.postSlide(i)
    ...
    function(t, e, n, i) {
        ...
        t.extend(o.prototype, {
            ...
            create_storage_wish: function() {
                for (var t = this, e = t.wish_storage_get(), n = 0, i = e.items.length; i > n; n++) {
                    var o = e.items[n].id,
                        s = e.items[n].name,
                        r = e.items[n].price,
                        a = e.items[n].image;
            ...
            create_storage_cart: function() {
                for (var t = this, e = t.storage_get(), n = 0, i = e.items.length; i > n; n++) {
                    var o = e.items[n].id,
                        s = e.items[n].name,
                        r = e.items[n].price,
                        a = e.items[n].image,
